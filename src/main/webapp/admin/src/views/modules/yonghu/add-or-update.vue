  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.nianling" label="年龄" prop="nianling">
              <el-input v-model="ruleForm.nianling" 
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.dianhua" label="电话" prop="dianhua">
              <el-input v-model="ruleForm.dianhua" 
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.youxiang" label="邮箱" prop="youxiang">
              <el-input v-model="ruleForm.youxiang" 
