  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" v-if="ruleForm.shangpinmingcheng" label="商品名称" prop="shangpinmingcheng">
              <el-input v-model="ruleForm.shangpinmingcheng" 
                placeholder="商品名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="商品类型" prop="youxileixing">
          <el-select v-model="ruleForm.youxileixing" placeholder="请选择商品类型">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.youxileixing" label="商品类型" prop="youxileixing">
