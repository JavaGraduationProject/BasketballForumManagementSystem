<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="订单id" prop="orderid">
            <el-input v-model="ruleForm.orderid" 
                placeholder="订单id" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.orderid" label="订单id" prop="orderid">
              <el-input v-model="ruleForm.orderid" 
                placeholder="订单id" readonly></el-input>
          </el-form-item>
        </div>
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.price" label="价格/积分" prop="price">
              <el-input v-model="ruleForm.price" 
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.discountprice" label="折扣价格" prop="discountprice">
              <el-input v-model="ruleForm.discountprice" 
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.total" label="总价格/总积分" prop="total">
              <el-input v-model="ruleForm.total" 
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.discounttotal" label="折扣总价格" prop="discounttotal">
              <el-input v-model="ruleForm.discounttotal" 
                placeholder="折扣总价格" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="支付类型（1：现金 2：积分）" prop="type">
          <el-input v-model="ruleForm.type" 
              placeholder="支付类型（1：现金 2：积分）" clearable></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.type" label="支付类型（1：现金 2：积分）" prop="type">
              <el-input v-model="ruleForm.type" 
                placeholder="支付类型（1：现金 2：积分）" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="状态" prop="status">
          <el-input v-model="ruleForm.status" 
              placeholder="状态" clearable></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.status" label="状态" prop="status">
              <el-input v-model="ruleForm.status" 
