<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="商品名称" prop="youximingcheng">
          ...
          <el-form-item class="input" v-if="ruleForm.youximingcheng" label="商品名称" prop="youximingcheng">
              <el-input v-model="ruleForm.youximingcheng" 
                placeholder="商品名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="商品厂商" prop="youxichangshang">
          <el-select v-model="ruleForm.youxichangshang" placeholder="请选择商品厂商">
            <el-option
