  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.refid" label="收藏id" prop="refid">
              <el-input v-model="ruleForm.refid" 
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.tablename" label="表名" prop="tablename">
              <el-input v-model="ruleForm.tablename" 
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.name" label="收藏名称" prop="name">
              <el-input v-model="ruleForm.name" 
